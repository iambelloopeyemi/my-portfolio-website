...
export default function Contact() {
  ...
  return (
    <section className="bg-anti-flash-white px-4 sm:px-20 pt-32 pb-16">
      ...
      >
        <Form className="bg-white p-5 sm:p-10 rounded drop-shadow">
          ...
          <label className="block mb-5">
            ...
            <div className="input-wrapper">
              ...
              <Field
                ...
                className="block sm:w-full h-32 bg-seasalt rounded outline-0 font-semibold"
              />
            </div>
          </label>
